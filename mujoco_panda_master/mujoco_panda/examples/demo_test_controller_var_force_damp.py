...
if __name__ == "__main__":
    ...
    for force_index in range(force_vect.shape[0]):
        ...
        print(p.model.geom_solref[17,0],p.model.geom_solref[17,1])
        #p.model.geom_solref[17,1] = dampratio_contact
        ...
        while i < target_traj.shape[0]:
            ...
            if i == 10: # activate force control when the robot is near the table
                ...
                ctrl.set_goal(target_traj[i, :],
                            target_ori, goal_force=[0, 0, -force_vect[force_index]], goal_torque=[0, 0, 0]) # target force in cartesian frame
            else:
