    ...
    def contact_forces(self, sim):
        ...
        if ncon != 0:
            ...
            for ll in range(len(efc_address_vect)):
                ...
                AR_diag[efc_address_vect[ll]] = A_diag[efc_address_vect[ll]] + R_diag[efc_address_vect[ll]]
                contact_forces_vect[efc_address_vect[ll]] = 1/(AR_diag[efc_address_vect[ll]]) * delta_a[efc_address_vect[ll]]
                combinations_forces_vect[index1] = combinations_forces_vect[index1] + contact_forces_vect[efc_address_vect[ll]]
